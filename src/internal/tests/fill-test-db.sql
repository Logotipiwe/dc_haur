...
VALUES ('4f84bde5-d6ad-4a2d-a2da-0553b4b281a2', 'd1', 1, 'l1', '', ''),
       ('dae6f634-8a6c-42a7-8d25-6a44e91e6e21', 'd1', 2, 'l2', '', ''),
       ('8e7e1f07-0292-4ef6-8529-fb92a0d4c1f6', 'd1', 3, 'l3', '', ''),

       ('de64eb23-9945-47fb-8da8-d8addac1dd47', 'd2', 1, 'l1', '', ''),
       ('d56a54ba-aeda-4a64-b290-87029b4802d5', 'd2', 2, 'l2', '', ''),
       ('5b0da819-cf98-435a-adb5-d36bf0778a9a', 'd2', 3, 'l3', '', ''),

       ('f34d9384-9181-4d0d-aa89-6d066cf77d44', 'd3', 1, 'l1', '', ''),
       ('95a7a834-8ff1-4ac2-a835-f75cf575697e', 'd3', 2, 'l2', '', '');
